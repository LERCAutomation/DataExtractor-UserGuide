# -*- coding: utf-8 -*-
#
# DataExtractor-UserGuide documentation build configuration file, created by
...
htmlhelp_basename = 'DataExtractor-UserGuidedoc'
...
man_pages = [
    ('index', 'Data Extractor-UserGuide', u'Data Extractor - User Guide',
...
texinfo_documents = [
  ('index', 'DataExtractor-UserGuide', u'Data Extractor - User Guide',
   u'Andy Foy & Hester Lyons', 'DataExtractor-UserGuide', 'Data Extractor - User Guide.',
   'Miscellaneous'),
]
